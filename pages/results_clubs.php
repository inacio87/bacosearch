<?php
/**
 * /pages/results_clubs.php - Lista de Clubes (padrão BacoSearch)
...
$page_specific_scripts = [['src' => SITE_URL . '/assets/js/clubs.js', 'attrs' => ['defer' => true]]];
...
$translations = [];
$keys_to_translate = [
    'results_clubs_title','results_clubs_meta_description','no_profiles_found','km_from_you','price_not_informed','years_old',
    'modal_select_planet','planet_earth','planet_earth_desc','planet_mars','planet_mars_desc',
    'planet_mars_message_1','planet_mars_message_2','planet_mars_message_3','mars_no_clubs',
...
/* ===================== META ===================== */
$page_title = $translations['results_clubs_title'] ?: 'results_clubs_title';
$meta_description = $translations['results_clubs_meta_description'] ?: (SEO_CONFIG['meta_description'] ?? '');
...
$initial_club_data = [ 'clubs' => [], 'level' => 'global' ];
$adData = [ 'global' => [] ];
...
<main class="search-main global-content-wrapper">
    ...
    <div class="results-container">
        ...
        <section id="results-grid">
            <?php if (empty($initial_club_data['clubs'])): ?>
...
const initialClubData = <?php echo json_encode($initial_club_data, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
